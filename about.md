...
Until 2017, I went by `Garth`, my first name, and then I started going by my middle name `Troy`. I also respond to and create art as `Dawn`.
...
In 2012, I launched the first Weave project, a node operator powered by Datafiniti. Sadly, Datafinity decomissioned the network in 2014 just as my next module, a browser extension called xdconsole that monitored the Datafinity workloads, was released.
